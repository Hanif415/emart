    ...
    @if (count($banners) > 0)
        ...
        <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-indicators">
                ...
                @foreach ($banners as $banner)
                    <button type="button" data-bs-target="#myCarousel" data-bs-slide-to="0"
                        class="{{ $j == 0 ? 'active' : '' }}" aria-current="true" aria-label="Slide 1"></button>
                    @php
                        $j++;
                    @endphp
                @endforeach
            ...
            <div class="carousel-inner">
                ...
                @endphp
                @foreach ($banners as $banner)
                    <div class=" carousel-item {{ $i == 1 ? 'active' : '' }}" id="slide{{ $i }}">
                        <img src="{{ $banner->photo }}" alt="{{ $banner->photo }}" width="100%" height="100%">
                        <div class="container">
